...
public class PacienteService {
    ...
    // Carga de pacientes iniciales en el arreglo
    public void cargarPacientesIniciales() {
        registrarPaciente(new Paciente("P001", "73748381", "Adrian", "Pisco Soto", "945834043", "adrian@correo.com", 22, "Gripe"));
        registrarPaciente(new Paciente("P002", "45879632", "Carlos", "Quispe", "987654321", "carlos@correo.com", 45, "Hipertensión"));
        registrarPaciente(new Paciente("P003", "74125896", "María", "Lopez", "999888777", "maria@correo.com", 30, "Migraña"));
    }
}